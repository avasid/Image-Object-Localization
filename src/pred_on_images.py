...
def predictions(RESOLUTION):
    ...
    for i in index:
        ...
        plt.gca().add_patch(plt.Rectangle((prediction[0]*RESOLUTION,prediction[1]*RESOLUTION),prediction[2]*RESOLUTION,prediction[3]*RESOLUTION,fill=False,edgecolor='green',linewidth=2,alpha=0.5))
        plt.show()
